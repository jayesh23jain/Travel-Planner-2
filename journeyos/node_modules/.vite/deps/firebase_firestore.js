import { A as deepEqual, C as Logger, E as FirebaseError, F as getGlobal, I as getModularInstance, J as pingServer, K as isSafari, L as getUA, N as getDefaultEmulatorHostnameAndPort, O as createMockUserToken, S as LogLevel, U as isIndexedDBAvailable, Z as updateEmulatorBanner, b as registerVersion, c as _getProvider, d as _registerComponent, f as _removeServiceInstance, h as getApp, n as SDK_VERSION, q as isSafariOrWebkit, u as _isFirebaseServerApp, w as Component, z as isCloudWorkstation } from "./index.esm2017-CQwz2_2L.js";
...
*/ var __PRIVATE_SimpleDb = class __PRIVATE_SimpleDb {
	...
	*/ async k(e) {
		return this.db || (__PRIVATE_logDebug(U, "Opening database:", this.name), this.db = await new Promise(((t, n) => {
			...
			this.L = e.target.version;
		}), { passive: !0 })), this.db.addEventListener("versionchange", ((e) => {
			var t;
	...
	async runTransaction(e, t, n, r) {
		...
		for (;;) {
			...
			try {
				...
				const t = __PRIVATE_SimpleDbTransaction.open(this.db, e, i ? "readonly" : "readwrite", n), s = r(t).next(((e) => (t.v(), e))).catch(((e) => (t.abort(e), PersistencePromise.reject(e)))).toPromise();
...
var __PRIVATE_WatchChangeAggregator = class {
		...
		if (r) {
			...
			if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
				...
				if (r !== n) {
					...
					pt?.ct(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e, t, n, r, i) {
						var s, o, _, a, u, c;
						const l = {
							localCacheCount: e,
	...
	*/ ht(e, t) {
		...
		return n.forEach(((n) => {
			...
			e.mightContain(s) || (this.Xe(t, n, null), r++);
		})), r;
	}
	/**
...
var __PRIVATE_IndexedDbIndexManager = class {
	constructor(e, t) {
		this.databaseId = t, this.vn = new __PRIVATE_MemoryCollectionParentIndex(), this.Cn = new ObjectMap(((e) => __PRIVATE_canonifyTarget(e)), ((e, t) => __PRIVATE_targetEquals(e, t))), this.uid = e.uid || "";
	}
	/**
	...
	*/ Nn(e, t, n, r, i, s, o) {
		...
		for (let c = 0; c < _; ++c) {
			const _ = t ? this.Bn(t[c / a]) : Ct, l = this.Ln(e, _, n[c % a], r), h = this.kn(e, _, i[c % a], s), P = o.map(((t) => this.Ln(e, _, t, !0)));
	...
	Mn(e, t) {
		...
		return this.getFieldIndexes(e, r).next(((e) => {
			let t = null;
			for (const r of e) n.pn(r) && (!t || r.fields.length > t.fields.length) && (t = r);
			return t;
		}));
	}
	getIndexType(e, t) {
...
function removeMutationBatch(e, t, n) {
	...
	let _ = 0;
	const a = r.X({ range: o }, ((e, t, n) => (_++, n.delete())));
	s.push(a.next((() => {
	...
	*/
	...
	getNextMutationBatchAfterBatchId(e, t) {
		...
		return __PRIVATE_mutationsStore(e).X({
			...
			t.userId === this.userId && (__PRIVATE_hardAssert(t.batchId >= n, 47524, { er: n }), i = __PRIVATE_fromDbMutationBatch(this.serializer, t)), r.done();
		})).next((() => i));
	}
	...
	getAllMutationBatchesAffectingDocumentKey(e, t) {
		...
		return __PRIVATE_documentMutationsStore(e).X({ range: r }, ((n, r, s) => {
	...
	getAllMutationBatchesAffectingDocumentKeys(e, t) {
		...
		const r = [];
		return t.forEach(((t) => {
			const i = __PRIVATE_newDbDocumentMutationPrefixForPath(this.userId, t.path), s = IDBKeyRange.lowerBound(i), o = __PRIVATE_documentMutationsStore(e).X({ range: s }, ((e, r, i) => {
	...
	getAllMutationBatchesAffectingQuery(e, t) {
		...
		return __PRIVATE_documentMutationsStore(e).X({ range: s }, ((e, t, i) => {
	...
	*/
	...
	performConsistencyCheck(e) {
		return this.checkEmpty(e).next(((t) => {
			...
			return __PRIVATE_documentMutationsStore(e).X({ range: n }, ((e, t, n) => {
				if (e[0] === this.userId) {
					const t = __PRIVATE_decodeResourcePath(e[1]);
					r.push(t);
				} else n.done();
			})).next((() => {
				__PRIVATE_hardAssert(0 === r.length, 56720, { ir: r.map(((e) => e.canonicalString())) });
			}));
		}));
	}
	containsKey(e, t) {
...
/** Provides LRU functionality for IndexedDB persistence. */ var __PRIVATE_IndexedDbLruDelegateImpl = class {
	...
	*/ wr(e, t) {
		...
		return n.X({ index: Ae }, (([e, n], { path: s, sequenceNumber: o }) => {
			0 === e ? (i !== __PRIVATE_ListenSequence.ue && t(new DocumentKey(__PRIVATE_decodeResourcePath(r)), i), i = o, r = s) : i = __PRIVATE_ListenSequence.ue;
		})).next((() => {
	...
	*/ Fr(e, t) {
	...
	Cr(e, t, n) {
		...
		return __PRIVATE_remoteDocumentsStore(e).X({
			...
			o && o.isEqual(i) && (n(o, t), o = s.hasNext() ? s.getNext() : null), o ? r.G(__PRIVATE_dbKey(o)) : r.done();
		})).next((() => {
...
*/ var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
	...
	*/
	constructor(e, t) {
		super(), this.Or = e, this.trackRemovals = t, this.Nr = new ObjectMap(((e) => e.toString()), ((e, t) => e.isEqual(t)));
	}
	applyChanges(e) {
		const t = [];
	...
	getAllFromCache(e, t) {
		return this.Or.Fr(e, t).next((({ documents: e, Mr: t }) => (t.forEach(((t, n) => {
			this.Nr.set(t, {
				size: n,
...
/** Performs database creation and schema upgrades. */ var __PRIVATE_SchemaConverter = class {
	...
	*/ q(e, t, n, r) {
		...
		n < 1 && r >= 1 && (function __PRIVATE_createPrimaryClientStore(e) {
			...
			e.createObjectStore(Y, { keyPath: Z });
			e.createObjectStore(X, {
				keyPath: ee,
				autoIncrement: !0
			}).createIndex(te, ne, { unique: !0 }), e.createObjectStore(ie);
		...
		return n < 3 && r >= 3 && (0 !== n && (function __PRIVATE_dropQueryCache(e) {
			...
			(function __PRIVATE_createDocumentOverlayStore(e) {
				const t = e.createObjectStore($e, { keyPath: Ue });
				t.createIndex(Ke, We, { unique: !1 }), t.createIndex(Ge, ze, { unique: !1 });
			})(e);
		}))), n < 13 && r >= 13 && (s = s.next((() => function __PRIVATE_createRemoteDocumentCache(e) {
			const t = e.createObjectStore(se, { keyPath: oe });
			...
			e.createObjectStore(Le, { keyPath: ke }).createIndex(qe, Qe, { unique: !1 });
			...
			(function __PRIVATE_createGlobalsStore(e) {
				e.createObjectStore(je, { keyPath: Je });
			})(e);
	...
	*/ wi(e) {
	...
	Si(e, t) {
		...
		return t.store(j).X({ Z: !0 }, ((e, t) => {
			return addEntry(new ResourcePath(e).popLast());
		})).next((() => t.store(ie).X({ Z: !0 }, (([e, t, n], r) => {
	...
	Ci(e, t) {
		...
		return n.j().next(((e) => {
			...
			return e.forEach(((e) => {
				...
				return new LocalDocumentsView(r, __PRIVATE_IndexedDbMutationQueue.yt(s, this.serializer, _, i.referenceDelegate), o, _).recalculateAndSaveOverlaysForDocumentKeys(new __PRIVATE_IndexedDbTransaction(t, __PRIVATE_ListenSequence.ue), e).next();
			}));
		}));
	}
};
...
var __PRIVATE_IndexedDbPersistence = class __PRIVATE_IndexedDbPersistence {
	constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
		if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.Fi = i, this.window = s, this.document = o, this.Mi = a, this.xi = u, this.Oi = c, this.ui = null, this.ci = !1, this.isPrimary = !1, this.networkEnabled = !0, this.Ni = null, this.inForeground = !1, this.Bi = null, this.Li = null, this.ki = Number.NEGATIVE_INFINITY, this.qi = (e) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.C()) throw new FirestoreError(N.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
	...
	*/ Gi() {
		...
		"function" == typeof (null === (e = this.window) || void 0 === e ? void 0 : e.addEventListener) && (this.Ni = () => {
			...
			isSafari() && (navigator.appVersion.match(e) || navigator.userAgent.match(e)) && this.Fi.enterRestrictedMode(!0), this.Fi.enqueueAndForget((() => this.shutdown()));
	...
	return n.persistence.runTransaction("Apply remote event", "readwrite-primary", ((e) => {
		...
		t.targetChanges.forEach(((s, _) => {
			...
			null !== t.targetMismatches.get(_) ? u = u.withResumeToken(ByteString.EMPTY_BYTE_STRING, SnapshotVersion.min()).withLastLimboFreeSnapshotVersion(SnapshotVersion.min()) : s.resumeToken.approximateByteSize() > 0 && (u = u.withResumeToken(s.resumeToken, r)), i = i.insert(_, u), function __PRIVATE_shouldPersistTargetData(e, t, n) {
				...
				if (t.snapshotVersion.toMicroseconds() - e.snapshotVersion.toMicroseconds() >= $t) return !0;
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
	...
	return n.persistence.runTransaction("Allocate target", "readwrite", ((e) => {
		let r;
		return n.hi.getTargetData(e, t).next(((i) => i ? (r = i, PersistencePromise.resolve(r)) : n.hi.allocateTargetId(e).next(((i) => (r = new TargetData(t, i, "TargetPurposeListen", e.currentSequenceNumber), n.hi.addTargetData(e, r).next((() => r)))))));
	})).then(((e) => {
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
	...
	return n.persistence.runTransaction("Get new document changes", "readonly", ((e) => n.Os.getAllFromCollectionGroup(e, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, Q), Number.MAX_SAFE_INTEGER))).then(((e) => (__PRIVATE_setMaxReadTime(n, t, e), e)));
}
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
	...
	const _ = i.Os.newChangeBuffer({ trackRemovals: !0 }), a = await __PRIVATE_localStoreAllocateTarget(i, function __PRIVATE_umbrellaTarget(e) {
...
*/ var __PRIVATE_WebStorageSharedClientState = class {
	constructor(e, t, n, r, i) {
		...
		const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
		this.storage = this.window.localStorage, this.currentUser = i, this.Xs = createWebStorageClientStateKey(this.persistenceKey, this.js), this.eo = function createWebStorageSequenceNumberKey(e) {
			return `firestore_sequence_number_${e}`;
		}(this.persistenceKey), this.Ys = this.Ys.insert(this.js, new __PRIVATE_LocalClientState()), this.no = new RegExp(`^${Ut}_${s}_([^_]*)$`), this.ro = new RegExp(`^${Kt}_${s}_(\\d+)(?:_(.*))?$`), this.io = new RegExp(`^${Wt}_${s}_(\\d+)$`), this.so = function createWebStorageOnlineStateKey(e) {
						...
						if (this.no.test(t.key)) {
							...
							const e = function __PRIVATE_fromWebStorageSequenceNumber(e) {
								...
								if (null != e) try {
									...
									__PRIVATE_hardAssert("number" == typeof n, 30636, { wo: e }), t = n;
								} catch (e) {
...
*/ var __PRIVATE_PersistentListenStream = class extends __PRIVATE_PersistentStream {
	...
	*/ H_(e) {
		...
		t.database = __PRIVATE_getEncodedDatabaseId(this.serializer), t.addTarget = function __PRIVATE_toTarget(e, t) {
			let n;
			const r = t.target;
			if (n = __PRIVATE_targetIsDocumentTarget(r) ? { documents: __PRIVATE_toDocumentsTarget(e, r) } : { query: __PRIVATE_toQueryTarget(e, r).Vt }, n.targetId = t.targetId, t.resumeToken.approximateByteSize() > 0) {
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
	if (e.Aa.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause) try {
		...
		await async function __PRIVATE_handleTargetError(e, t) {
			const n = t.cause;
			for (const r of t.targetIds) e.Ta.has(r) && (await e.remoteSyncer.rejectListen(r, n), e.Ta.delete(r), e.Ra.removeTarget(r));
		}(e, t);
	} catch (n) {
...
async function __PRIVATE_onWriteStreamClose(e, t) {
	t && __PRIVATE_ensureWriteStream(e).Z_ && await async function __PRIVATE_handleWriteError(e, t) {
...
*/ function __PRIVATE_ensureWatchStream(e) {
	return e.Va || (e.Va = function __PRIVATE_newPersistentWatchStream(e, t, n) {
		const r = __PRIVATE_debugCast(e);
...
*/ function __PRIVATE_ensureWriteStream(e) {
	return e.ma || (e.ma = function __PRIVATE_newPersistentWriteStream(e, t, n) {
		const r = __PRIVATE_debugCast(e);
...
async function __PRIVATE_eventManagerUnlisten(e, t) {
	...
	if (s) {
		...
		e >= 0 && (s.wa.splice(e, 1), 0 === s.wa.length ? i = t.ba() ? 0 : 1 : !s.Sa() && t.ba() && (i = 2));
	}
	switch (i) {
...
*/ async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
	e.gu = (t, n, r) => async function __PRIVATE_applyDocChanges(e, t, n, r) {
		let i = t.view.nu(n);
		i.Ds && (i = await __PRIVATE_localStoreExecuteQuery(e.localStore, t.query, !1).then((({ documents: e }) => t.view.nu(e, i))));
...
*/ async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
	...
	try {
		...
		t.targetChanges.forEach(((e, t) => {
			const r = n.Eu.get(t);
			r && (__PRIVATE_hardAssert(e.addedDocuments.size + e.modifiedDocuments.size + e.removedDocuments.size <= 1, 22616), e.addedDocuments.size > 0 ? r.lu = !0 : e.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r.lu, 14607) : e.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r.lu, 42227), r.lu = !1));
...
*/ async function __PRIVATE_syncEngineRejectListen(e, t, n) {
	...
	if (s) {
		...
		await __PRIVATE_syncEngineApplyRemoteEvent(r, new RemoteEvent(SnapshotVersion.min(), /* @__PURE__ */ new Map(), new SortedMap(__PRIVATE_primitiveComparator), e, n)), r.du = r.du.remove(s), r.Eu.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
	...
	if (e.Tu.delete(t), e.isPrimaryClient) e.Au.zr(t).forEach(((t) => {
		e.Au.containsKey(t) || __PRIVATE_removeLimboTarget(e, t);
	}));
}
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
	...
	if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), !0 === t && !0 !== n.fu) {
		...
		n.Tu.forEach(((r, i) => {
			...
			})), t.Au.jr(), t.Eu = /* @__PURE__ */ new Map(), t.du = new SortedMap(DocumentKey.comparator);
...
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
	...
	for (const e of t) {
		...
		if (n && 0 !== n.length) {
			...
			for (const e of n) {
				const n = await __PRIVATE_synchronizeViewAndComputeSnapshot(r, r.Pu.get(e));
...
/** Adds or removes Watch targets for queries from different tabs. */ async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
	...
	if (r.fu) {
		...
		for (const e of n) r.Tu.has(e) && await __PRIVATE_localStoreReleaseTarget(r.localStore, e, !1).then((() => {
...
*/ function __PRIVATE_syncEngineLoadBundle(e, t, n) {
	...
	(async function __PRIVATE_loadBundleImpl(e, t, n) {
		try {
			...
			return __PRIVATE_logWarn(nn, `Loading bundle failed with ${e}`), n._failWith(e), Promise.resolve(/* @__PURE__ */ new Set());
		}
	})(r, t, n).then(((e) => {
...
*/ var __PRIVATE_BundleReaderImpl = class {
	constructor(e, t) {
		this.Nu = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.Bu = function __PRIVATE_newTextDecoder() {
			...
			e && e.Qa() ? this.metadata.resolve(e.qa.metadata) : this.metadata.reject(/* @__PURE__ */ new Error(`The first element of the bundle is not a metadata, it is\n             ${JSON.stringify(null == e ? void 0 : e.qa)}`));
...
async function __PRIVATE_setOnlineComponentProvider(e, t) {
	...
	__PRIVATE_logDebug(rn, "Initializing OnlineComponentProvider"), await t.initialize(n, e.configuration), e.setCredentialChangeListener(((e) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, e))), e.setAppCheckTokenChangeListener(((e, n) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, n))), e._onlineComponents = t;
}
/**
...
/** Disables the network connection. Pending operations will not complete. */ function __PRIVATE_firestoreClientDisableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!1), async function __PRIVATE_remoteStoreDisableNetwork(e) {
			const t = __PRIVATE_debugCast(e);
			t.Ia.add(0), await __PRIVATE_disableNetworkInternal(t), t.Aa.set("Offline");
		}(n);
	}));
}
/**
...
function __PRIVATE_firestoreClientGetDocumentsFromLocalCache(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => async function __PRIVATE_executeQueryFromCache(e, t, n) {
		try {
			const r = await __PRIVATE_localStoreExecuteQuery(e, t, !0), i = new __PRIVATE_View(t, r.qs), s = i.nu(r.documents), o = i.applyChanges(s, !1);
	...
	return e.asyncQueue.enqueueAndForget((async () => {
		try {
			...
			r.resolve(async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
				...
				const a = (await i.Jo("RunAggregationQuery", i.serializer.databaseId, _, s, 1)).filter(((e) => !!e.result));
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
	...
	return e.asyncQueue.enqueueAndForget((async () => function __PRIVATE_addSnapshotsInSyncListener(e, t) {
		__PRIVATE_debugCast(e).Da.add(t), t.next();
		...
		*/
		return function __PRIVATE_parseVectorValue(e, t) {
			return { mapValue: { fields: {
				[ct]: { stringValue: Pt },
				[Tt]: { arrayValue: { values: e.toArray().map(((e) => {
...
var AbstractUserDataWriter = class {
	...
	*/ convertVectorValue(e) {
		var t, n, r;
		return new VectorValue(null === (r = null === (n = null === (t = e.fields) || void 0 === t ? void 0 : t[Tt].arrayValue) || void 0 === n ? void 0 : n.values) || void 0 === r ? void 0 : r.map(((e) => __PRIVATE_normalizeNumber(e.doubleValue))));
	}
	convertGeoPoint(e) {
